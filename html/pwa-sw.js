...
const BASE_CACHE_FILES = [
    'https://itshellws.apps.itshellws-k8s.com/wp-content/plugins/pwa-for-wp/images/logo.png',
'https://itshellws.apps.itshellws-k8s.com/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',

];

const OFFLINE_CACHE_FILES = [
     'https://itshellws.apps.itshellws-k8s.com/',
];
...
const OFFLINE_PAGE = 'https://itshellws.apps.itshellws-k8s.com/';
const NOT_FOUND_PAGE = 'https://itshellws.apps.itshellws-k8s.com/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://itshellws.apps.itshellws-k8s.com//wp-admin/');
//    },
];
